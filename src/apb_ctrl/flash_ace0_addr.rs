...
pub struct FLASH_ACE0_ADDR_S_R(crate::FieldReader<u32, u32>);
impl FLASH_ACE0_ADDR_S_R {
    pub(crate) fn new(bits: u32) -> Self {
        FLASH_ACE0_ADDR_S_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FLASH_ACE0_ADDR_S_R {
