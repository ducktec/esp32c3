...
#[doc = "Field `FLASH_ACE2_ADDR_S` reader - "]
pub struct FLASH_ACE2_ADDR_S_R(crate::FieldReader<u32, u32>);
impl FLASH_ACE2_ADDR_S_R {
    pub(crate) fn new(bits: u32) -> Self {
        FLASH_ACE2_ADDR_S_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FLASH_ACE2_ADDR_S_R {
...
#[doc = "Field `FLASH_ACE2_ADDR_S` writer - "]
...
#[doc = "`reset()` method sets FLASH_ACE2_ADDR to value 0"]
