...
#[doc = "Field `CALI_CFG` reader - "]
pub struct CALI_CFG_R(crate::FieldReader<u32, u32>);
impl CALI_CFG_R {
    pub(crate) fn new(bits: u32) -> Self {
        CALI_CFG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CALI_CFG_R {
...
#[doc = "Field `CALI_CFG` writer - "]
pub struct CALI_CFG_W<'a> {
    w: &'a mut W,
}
impl<'a> CALI_CFG_W<'a> {
...
impl R {
    #[doc = "Bits 0:16"]
    #[inline(always)]
    pub fn cali_cfg(&self) -> CALI_CFG_R {
        CALI_CFG_R::new((self.bits & 0x0001_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:16"]
    #[inline(always)]
    pub fn cali_cfg(&mut self) -> CALI_CFG_W {
        CALI_CFG_W { w: self }
    }
