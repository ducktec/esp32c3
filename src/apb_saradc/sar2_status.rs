...
pub struct SAR2_STATUS_R(crate::FieldReader<u32, u32>);
impl SAR2_STATUS_R {
    pub(crate) fn new(bits: u32) -> Self {
        SAR2_STATUS_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SAR2_STATUS_R {
...
impl R {
    ...
    pub fn sar2_status(&self) -> SAR2_STATUS_R {
        SAR2_STATUS_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
