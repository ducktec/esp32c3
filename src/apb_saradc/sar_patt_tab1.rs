...
#[doc = "Field `SAR_PATT_TAB1` reader - "]
pub struct SAR_PATT_TAB1_R(crate::FieldReader<u32, u32>);
impl SAR_PATT_TAB1_R {
    pub(crate) fn new(bits: u32) -> Self {
        SAR_PATT_TAB1_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SAR_PATT_TAB1_R {
...
#[doc = "Field `SAR_PATT_TAB1` writer - "]
pub struct SAR_PATT_TAB1_W<'a> {
    w: &'a mut W,
}
impl<'a> SAR_PATT_TAB1_W<'a> {
...
impl R {
    ...
    pub fn sar_patt_tab1(&self) -> SAR_PATT_TAB1_R {
        SAR_PATT_TAB1_R::new((self.bits & 0x00ff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:23"]
    #[inline(always)]
    pub fn sar_patt_tab1(&mut self) -> SAR_PATT_TAB1_W {
        SAR_PATT_TAB1_W { w: self }
    }
