...
#[doc = "Field `THRES1_LOW` reader - "]
pub struct THRES1_LOW_R(crate::FieldReader<u16, u16>);
impl THRES1_LOW_R {
...
#[doc = "Field `THRES1_HIGH` reader - "]
pub struct THRES1_HIGH_R(crate::FieldReader<u16, u16>);
impl THRES1_HIGH_R {
    pub(crate) fn new(bits: u16) -> Self {
...
#[doc = "Field `THRES1_CHANNEL` reader - "]
pub struct THRES1_CHANNEL_R(crate::FieldReader<u8, u8>);
...
#[doc = "Field `THRES1_CHANNEL` writer - "]
...
#[doc = "`reset()` method sets THRES1_CTRL to value 0"]
