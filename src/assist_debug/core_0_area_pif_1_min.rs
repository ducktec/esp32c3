...
#[doc = "Field `CORE_0_AREA_PIF_1_MIN` reader - "]
...
#[doc = "Field `CORE_0_AREA_PIF_1_MIN` writer - "]
...
impl R {
    ...
    pub fn core_0_area_pif_1_min(&self) -> CORE_0_AREA_PIF_1_MIN_R {
        CORE_0_AREA_PIF_1_MIN_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
...
#[doc = "`reset()` method sets CORE_0_AREA_PIF_1_MIN to value 0"]
