...
#[doc = "Field `LOG_MEM_LOOP_ENABLE` reader - "]
...
#[doc = "Field `LOG_MEM_LOOP_ENABLE` writer - "]
...
#[doc = "`reset()` method sets LOG_SETTING to value 0"]
