...
#[doc = "Field `REPEAT_ERR_CNT` reader - "]
...
#[doc = "Field `OTP_VDDQ_IS_SW` reader - "]
...
#[doc = "Field `OTP_STROBE_SW` reader - "]
...
#[doc = "Field `OTP_VDDQ_C_SYNC2` reader - "]
