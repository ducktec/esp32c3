...
#[doc = "Field `ICACHE_PRELOAD_INT_CLR` writer - "]
...
#[doc = "Field `ICACHE_PRELOAD_INT_ENA` reader - "]
...
#[doc = "Field `ICACHE_PRELOAD_INT_ENA` writer - "]
...
#[doc = "Field `ICACHE_PRELOAD_INT_ST` reader - "]
