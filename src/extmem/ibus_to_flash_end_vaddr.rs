...
#[doc = "Field `IBUS_TO_FLASH_END_VADDR` reader - "]
...
#[doc = "Field `IBUS_TO_FLASH_END_VADDR` writer - "]
...
impl R {
    ...
    pub fn ibus_to_flash_end_vaddr(&self) -> IBUS_TO_FLASH_END_VADDR_R {
        IBUS_TO_FLASH_END_VADDR_R::new((self.bits & 0xffff_ffff) as u32)
    }
}
impl W {
    #[doc = "Bits 0:31"]
...
#[doc = "`reset()` method sets IBUS_TO_FLASH_END_VADDR to value 0"]
