...
impl<'a> DMA_MEM_TRANS_EN_CH2_W<'a> {
...
impl<'a> DMA_IN_DATA_BURST_EN_CH2_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl<'a> DMA_INDSCR_BURST_EN_CH2_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl<'a> DMA_IN_LOOP_TEST_CH2_W<'a> {
    #[doc = r"Sets the field bit"]
    #[inline(always)]
    pub fn set_bit(self) -> &'a mut W {
        self.bit(true)
...
impl R {
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn dma_mem_trans_en_ch2(&self) -> DMA_MEM_TRANS_EN_CH2_R {
        DMA_MEM_TRANS_EN_CH2_R::new(((self.bits >> 4) & 0x01) != 0)
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn dma_in_data_burst_en_ch2(&self) -> DMA_IN_DATA_BURST_EN_CH2_R {
        DMA_IN_DATA_BURST_EN_CH2_R::new(((self.bits >> 3) & 0x01) != 0)
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn dma_indscr_burst_en_ch2(&self) -> DMA_INDSCR_BURST_EN_CH2_R {
        DMA_INDSCR_BURST_EN_CH2_R::new(((self.bits >> 2) & 0x01) != 0)
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn dma_in_loop_test_ch2(&self) -> DMA_IN_LOOP_TEST_CH2_R {
        DMA_IN_LOOP_TEST_CH2_R::new(((self.bits >> 1) & 0x01) != 0)
    }
    #[doc = "Bit 0"]
    #[inline(always)]
    pub fn dma_in_rst_ch2(&self) -> DMA_IN_RST_CH2_R {
        DMA_IN_RST_CH2_R::new((self.bits & 0x01) != 0)
    }
}
impl W {
    #[doc = "Bit 4"]
    #[inline(always)]
    pub fn dma_mem_trans_en_ch2(&mut self) -> DMA_MEM_TRANS_EN_CH2_W {
        DMA_MEM_TRANS_EN_CH2_W { w: self }
    }
    #[doc = "Bit 3"]
    #[inline(always)]
    pub fn dma_in_data_burst_en_ch2(&mut self) -> DMA_IN_DATA_BURST_EN_CH2_W {
        DMA_IN_DATA_BURST_EN_CH2_W { w: self }
    }
    #[doc = "Bit 2"]
    #[inline(always)]
    pub fn dma_indscr_burst_en_ch2(&mut self) -> DMA_INDSCR_BURST_EN_CH2_W {
        DMA_INDSCR_BURST_EN_CH2_W { w: self }
    }
    #[doc = "Bit 1"]
    #[inline(always)]
    pub fn dma_in_loop_test_ch2(&mut self) -> DMA_IN_LOOP_TEST_CH2_W {
        DMA_IN_LOOP_TEST_CH2_W { w: self }
    }
    #[doc = "Bit 0"]
    #[inline(always)]
