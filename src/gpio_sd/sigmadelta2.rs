...
pub struct SD2_PRESCALE_R(crate::FieldReader<u8, u8>);
impl SD2_PRESCALE_R {
    pub(crate) fn new(bits: u8) -> Self {
        SD2_PRESCALE_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SD2_PRESCALE_R {
...
pub struct SD2_IN_R(crate::FieldReader<u8, u8>);
impl SD2_IN_R {
    pub(crate) fn new(bits: u8) -> Self {
        SD2_IN_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SD2_IN_R {
    type Target = crate::FieldReader<u8, u8>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
