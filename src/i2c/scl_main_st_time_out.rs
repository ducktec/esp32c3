...
#[doc = "Field `SCL_MAIN_ST_TO_REG` reader - "]
pub struct SCL_MAIN_ST_TO_REG_R(crate::FieldReader<u8, u8>);
impl SCL_MAIN_ST_TO_REG_R {
    pub(crate) fn new(bits: u8) -> Self {
        SCL_MAIN_ST_TO_REG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SCL_MAIN_ST_TO_REG_R {
...
#[doc = "Field `SCL_MAIN_ST_TO_REG` writer - "]
