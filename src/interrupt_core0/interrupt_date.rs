...
pub struct R(crate::R<INTERRUPT_DATE_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<INTERRUPT_DATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<INTERRUPT_DATE_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<INTERRUPT_DATE_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `INTERRUPT_DATE` writer"]
pub struct W(crate::W<INTERRUPT_DATE_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<INTERRUPT_DATE_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<INTERRUPT_DATE_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<INTERRUPT_DATE_SPEC>) -> Self {
        W(writer)
    }
}
...
#[doc = "`reset()` method sets INTERRUPT_DATE to value 0"]
