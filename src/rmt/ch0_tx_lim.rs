...
#[doc = "Field `LOOP_COUNT_RESET` writer - "]
...
#[doc = "Field `TX_LOOP_CNT_EN` reader - "]
...
#[doc = "Field `TX_LOOP_CNT_EN` writer - "]
...
impl R {
    ...
    pub fn tx_loop_cnt_en(&self) -> TX_LOOP_CNT_EN_R {
        TX_LOOP_CNT_EN_R::new(((self.bits >> 19) & 0x01) != 0)
    }
    #[doc = "Bits 9:18"]
    #[inline(always)]
...
#[doc = "`reset()` method sets CH0_TX_LIM to value 0"]
