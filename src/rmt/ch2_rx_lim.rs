...
#[doc = "Field `RX_LIM_CH2` reader - "]
pub struct RX_LIM_CH2_R(crate::FieldReader<u16, u16>);
impl RX_LIM_CH2_R {
    pub(crate) fn new(bits: u16) -> Self {
        RX_LIM_CH2_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for RX_LIM_CH2_R {
