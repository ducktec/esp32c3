...
#[doc = "Field `SDA_DUTY_NUM` reader - "]
pub struct SDA_DUTY_NUM_R(crate::FieldReader<u32, u32>);
impl SDA_DUTY_NUM_R {
    pub(crate) fn new(bits: u32) -> Self {
        SDA_DUTY_NUM_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for SDA_DUTY_NUM_R {
