...
#[doc = "Field `FIB_SEL` reader - "]
pub struct FIB_SEL_R(crate::FieldReader<u8, u8>);
impl FIB_SEL_R {
    pub(crate) fn new(bits: u8) -> Self {
        FIB_SEL_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for FIB_SEL_R {
