...
pub struct SLOW_CLK_NEXT_EDGE_R(crate::FieldReader<bool, bool>);
...
#[doc = "Field `ANA_CLK_DIV_VLD` reader - "]
...
#[doc = "Field `ANA_CLK_DIV_VLD` writer - "]
...
#[doc = "`reset()` method sets SLOW_CLK_CONF to value 0"]
