...
#[doc = "Field `DMA_APBPERI_PMS_MONITOR_VIOLATE_EN` reader - "]
...
#[doc = "Field `DMA_APBPERI_PMS_MONITOR_VIOLATE_EN` writer - "]
...
#[doc = "Field `DMA_APBPERI_PMS_MONITOR_VIOLATE_CLR` reader - "]
...
#[doc = "Field `DMA_APBPERI_PMS_MONITOR_VIOLATE_CLR` writer - "]
...
#[doc = "`reset()` method sets DMA_APBPERI_PMS_MONITOR_1 to value 0"]
