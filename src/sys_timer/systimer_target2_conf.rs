#[doc = "Register `SYSTIMER_TARGET2_CONF` reader"]
pub struct R(crate::R<SYSTIMER_TARGET2_CONF_SPEC>);
impl core::ops::Deref for R {
    type Target = crate::R<SYSTIMER_TARGET2_CONF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
}
impl From<crate::R<SYSTIMER_TARGET2_CONF_SPEC>> for R {
    #[inline(always)]
    fn from(reader: crate::R<SYSTIMER_TARGET2_CONF_SPEC>) -> Self {
        R(reader)
    }
}
#[doc = "Register `SYSTIMER_TARGET2_CONF` writer"]
pub struct W(crate::W<SYSTIMER_TARGET2_CONF_SPEC>);
impl core::ops::Deref for W {
    type Target = crate::W<SYSTIMER_TARGET2_CONF_SPEC>;
    #[inline(always)]
    fn deref(&self) -> &Self::Target {
        &self.0
    }
...
impl From<crate::W<SYSTIMER_TARGET2_CONF_SPEC>> for W {
    #[inline(always)]
    fn from(writer: crate::W<SYSTIMER_TARGET2_CONF_SPEC>) -> Self {
        W(writer)
    }
}
#[doc = "Field `TARGET2_TIMER_UNIT_SEL` reader - "]
...
#[doc = "Field `TARGET2_TIMER_UNIT_SEL` writer - "]
...
#[doc = "Field `TARGET2_PERIOD_MODE` reader - "]
...
#[doc = "Field `TARGET2_PERIOD_MODE` writer - "]
...
#[doc = "Field `TARGET2_PERIOD` reader - "]
...
#[doc = "Field `TARGET2_PERIOD` writer - "]
...
#[doc = "SYS_TIMER_SYSTIMER_TARGET2_CONF\n\nThis register you can [`read`](crate::generic::Reg::read), [`write_with_zero`](crate::generic::Reg::write_with_zero), [`reset`](crate::generic::Reg::reset), [`write`](crate::generic::Reg::write), [`modify`](crate::generic::Reg::modify). See [API](https://docs.rs/svd2rust/#read--modify--write-api).\n\nFor information about available fields see [systimer_target2_conf](index.html) module"]
pub struct SYSTIMER_TARGET2_CONF_SPEC;
impl crate::RegisterSpec for SYSTIMER_TARGET2_CONF_SPEC {
    type Ux = u32;
}
#[doc = "`read()` method returns [systimer_target2_conf::R](R) reader structure"]
impl crate::Readable for SYSTIMER_TARGET2_CONF_SPEC {
    type Reader = R;
}
#[doc = "`write(|w| ..)` method takes [systimer_target2_conf::W](W) writer structure"]
impl crate::Writable for SYSTIMER_TARGET2_CONF_SPEC {
    type Writer = W;
}
#[doc = "`reset()` method sets SYSTIMER_TARGET2_CONF to value 0"]
impl crate::Resettable for SYSTIMER_TARGET2_CONF_SPEC {
    #[inline(always)]
