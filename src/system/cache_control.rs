...
#[doc = "Field `DCACHE_CLK_ON` reader - "]
...
#[doc = "Field `DCACHE_CLK_ON` writer - "]
...
#[doc = "Field `ICACHE_CLK_ON` reader - "]
...
#[doc = "Field `ICACHE_CLK_ON` writer - "]
...
#[doc = "`reset()` method sets CACHE_CONTROL to value 0"]
