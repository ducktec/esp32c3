...
#[doc = "Field `COMB_PVT_MONITOR_EN_HVT` reader - "]
...
#[doc = "Field `COMB_PVT_MONITOR_EN_HVT` writer - "]
...
#[doc = "Field `COMB_ERR_CNT_CLR_HVT` writer - "]
...
#[doc = "Field `COMB_PATH_LEN_HVT` reader - "]
...
#[doc = "Field `COMB_PATH_LEN_HVT` writer - "]
...
#[doc = "`reset()` method sets COMB_PVT_HVT_CONF to value 0"]
