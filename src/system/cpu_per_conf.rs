...
#[doc = "Field `CPU_WAITI_DELAY_NUM` reader - "]
...
#[doc = "Field `CPU_WAITI_DELAY_NUM` writer - "]
...
#[doc = "Field `CPU_WAIT_MODE_FORCE_ON` reader - "]
...
#[doc = "Field `CPU_WAIT_MODE_FORCE_ON` writer - "]
