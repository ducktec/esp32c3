...
#[doc = "Field `CLKDIV_FRAG` reader - "]
pub struct CLKDIV_FRAG_R(crate::FieldReader<u8, u8>);
impl CLKDIV_FRAG_R {
    pub(crate) fn new(bits: u8) -> Self {
        CLKDIV_FRAG_R(crate::FieldReader::new(bits))
    }
}
impl core::ops::Deref for CLKDIV_FRAG_R {
